...
import { activeElement, contains, createAttribute, getDocument, getTarget, isVirtualPointerEvent, } from "../internal/dom";
...
function useFocus(context, options = {}) {
    ...
    const { open, onOpenChange, events, elements: { reference, floating }, } = contextMemo();
    ...
    createEffect(() => {
        ...
        function onOpenChangeHandler({ reason }) {
            ...
            return {
                ...
                onBlur: (event) => {
                    ...
                    timeout = window.setTimeout(() => {
                        ...
                        if (!relatedTarget && activeEl === reference)
                            return;
